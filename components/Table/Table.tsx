...
export const Table = ({ fullList }: TableProps) => {
    ...
    const [displayingData, setDisplayingData] = useState(processedList.slice(0, 10));
    ...
    const handleFilter = (event: ChangeEvent<HTMLInputElement>) => {
        ...
        if (keyword.length === 0) {
            setDisplayingData(() => processedList.slice(currentPage * 10, (currentPage + 1) * 10));
        } else {
        ...
        if (context === "clear" || context === 'All') {
            ...
            switch (value) {
                case "Vote": {
                    ...
                    setDisplayingData(filteredList.slice(currentPage * 10, (currentPage + 1) * 10));
                    return;
                }
