  ...
  return (
    <PopoverPrimitive.Root modal>
      <PopoverPrimitive.Trigger asChild>
        <button className="rounded-full p-0.5 text-xs font-bold text-violet-600 outline-slate-500 focus-visible:outline-dashed focus-visible:outline-2 focus-visible:outline-offset-0 dark:text-violet-300 dark:outline-slate-200">
      ...
      >
        ...
        <h1 className="font-bold text-gray-800 dark:text-gray-100">Synopsis</h1>
